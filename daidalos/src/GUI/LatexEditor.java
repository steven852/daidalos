...
public  class LatexEditor extends JFrame implements ActionListener,KeyListener {
	 JMenuBar menubar;
     ...
     public static void main(String[] args){
    	 LatexEditor fr = new LatexEditor();
		 centerFrame(fr);
    	 maximiseFrame(fr);
    	 fr.setVisible(true);
	...
	public LatexEditor(){
	 ...
	 public void actionPerformed(ActionEvent e){
		 ...
		 TemplateFactory templates = new TemplateFactory();
		 
		 Template atemplate = templates.getTemplateType("Article");
		 Template btemplate = templates.getTemplateType("Book");
		 Template rtemplate = templates.getTemplateType("Report");
		 Template ltemplate = templates.getTemplateType("Letter");
		 
		 
		 TypeOfCommandsFactory commands = new TypeOfCommandsFactory();
		 
		 TypeOfCommands divcom = commands.getType("Division");
		 TypeOfCommands listcom = commands.getType("List");
		 TypeOfCommands tablecom = commands.getType("Table");
		 TypeOfCommands figcom = commands.getType("Figure");
		 ...
		 if(e.getSource().equals(bchapter)){
			 previousContent = textarea.getText();
			 textarea.insert(divcom.addCommandType("chapter"), textarea.getCaretPosition());
			 currentContent = textarea.getText();
			 versionTracker.currentVersion(currentContent);
			 versionTracker.previousVersion(previousContent);
		 }
		 ...
		 if(e.getSource().equals(bsection)){
			 previousContent = textarea.getText();
			 textarea.insert(divcom.addCommandType("section"), textarea.getCaretPosition());
			 currentContent = textarea.getText();
			 versionTracker.currentVersion(currentContent);
			 versionTracker.previousVersion(previousContent);
		 }
	     ...
	     if(e.getSource().equals(bsubsection)){
	    	 previousContent = textarea.getText();
	    	 textarea.insert(divcom.addCommandType("subsection"), textarea.getCaretPosition());
			 currentContent = textarea.getText();
			 versionTracker.currentVersion(currentContent);
			 versionTracker.previousVersion(previousContent);
		 }
	     ...
	     if(e.getSource().equals(bsubsubsection)){
			 previousContent = textarea.getText();
	    	 textarea.insert(divcom.addCommandType("subsubsection"), textarea.getCaretPosition());
			 currentContent = textarea.getText();
			 versionTracker.currentVersion(currentContent);
			 versionTracker.previousVersion(previousContent);
		 }
	     ...
	     if(e.getSource().equals(rItem_list)){
			 previousContent = textarea.getText();
	    	 textarea.insert(listcom.addCommandType("itemize"), textarea.getCaretPosition());
			 currentContent = textarea.getText();
			 versionTracker.currentVersion(currentContent);
			 versionTracker.previousVersion(previousContent);
	     }
	     ...
	     if(e.getSource().equals(rEnumerate_list)){
			 previousContent = textarea.getText();
	    	 textarea.insert(listcom.addCommandType("enumerate"), textarea.getCaretPosition());
			 currentContent = textarea.getText();
			 versionTracker.currentVersion(currentContent);
			 versionTracker.previousVersion(previousContent);
	     }
	     ...
	     if(e.getSource().equals(rtable)){
	    	 ...
	    	 textarea.insert(tablecom.addCommandType("table"), textarea.getCaretPosition());
			 currentContent = textarea.getText();
			 versionTracker.currentVersion(currentContent);
			 versionTracker.previousVersion(previousContent);
	     }
	     ...
	     if(e.getSource().equals(rfigure)){
			 previousContent = textarea.getText();
	    	 textarea.insert(figcom.addCommandType("figure"), textarea.getCaretPosition());
			 currentContent = textarea.getText();
			 versionTracker.currentVersion(currentContent);
			 versionTracker.previousVersion(previousContent);
		 }
	...
	private static void maximiseFrame(LatexEditor fr) {
		// TODO Auto-generated method stub
		
	}
	
	private static void centerFrame(LatexEditor fr) {
		// TODO Auto-generated method stub
